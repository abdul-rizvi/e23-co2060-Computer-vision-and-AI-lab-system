...
| **Backend** | ![node.js](https://img.shields.io/badge/Node.js-339933?style=flat-square&logo=node.js&logoColor=white) | Robust API handling, Auth, and Admin interface. |
...
| **API** | REST / Express | Node.js REST Framework for client-server communication. |

---

## 🏗️ Architecture

The system follows a modular design where the Backend (Node.js + Express) serves as the API provider for the Frontend (React).
